...
export function vsRow(m, colorsOf, extraHtml = '', opts = {}) {
  ...
  const fav = isFollowed(m.team1) || isFollowed(m.team2) ? ' followed' : '';
  return `<div class="vs-row${opts.hideGround ? ' compact' : ''}${fav}" data-num="${m.num}" title="Click for match details" style="--c1:${c1};--c2:${c2};">
